        ...
        return current
          ...
          .then(sql => {
            expectsql(sql, {
              ...
              oracle:
                "BEGIN EXECUTE IMMEDIATE 'ALTER TABLE users MODIFY (level_id FLOAT NOT NULL)'; EXCEPTION WHEN OTHERS THEN IF SQLCODE = -1442 OR SQLCODE = -1451 THEN EXECUTE IMMEDIATE 'ALTER TABLE users MODIFY (level_id FLOAT )'; ELSE RAISE; END IF; END;",
              postgres:
